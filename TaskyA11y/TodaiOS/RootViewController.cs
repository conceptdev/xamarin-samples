...
namespace TaskyA11y
{
	public partial class RootViewController : UITableViewController
	{
		...
		{
			Title = NSBundle.MainBundle.LocalizedString ("Toda", "");
			
			// Custom initialization
			tasks = new List<TodoItem> {
					new TodoItem() {Name="Groceries", Notes="Buy bread, cheese, apples", Done=false},
					new TodoItem() {Name="Devices", Notes="Buy Nexus, Galaxy, Droid", Done=false}
			};
